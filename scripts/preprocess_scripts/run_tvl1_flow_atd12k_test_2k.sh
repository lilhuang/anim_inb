...
#output file
#SBATCH --error=logs/run_tvl1_flow_atd12k_test.err
#SBATCH --output=logs/run_tvl1_flow_atd12k_test.log
...
DATASETDIR=/fs/vulcan-projects/anim_inb_lilhuang/datasets/test_2k_original_preprocess_dog
PREPROCESSDIR=/fs/vulcan-projects/anim_inb_lilhuang/datasets/test_2k_original_preprocess_dog
FLOWDIR=/fs/vulcan-projects/anim_inb_lilhuang/datasets/test_2k_preprocess_tvl1_flows
WORKINGFLOWDIR=/fs/vulcan-projects/anim_inb_lilhuang/datasets/working_flow_dir_2
