...
#output file
#SBATCH --output=train_RIFE_SU_halfhalf.log
#SBATCH --error=train_RIFE_SU_halfhalf.err
...
# --csv_root=/fs/cfar-projects/anim_inb/datasets/SU_24fps/StevenHug_2048x1024_smol_sequential_halfhalf_csv
...
# --batch_size=1 \
# --csv_root=/fs/cfar-projects/anim_inb/datasets/SU_24fps/StevenHug_2048x1024_smol_sequential_halfhalf_csv \
# --log_path=train_log_bs1

# python3 -m torch.distributed.launch --nproc_per_node=4 train1.py --world_size=4 \
# --epoch=4000 \
# --batch_size=16 \
# --csv_root=/fs/cfar-projects/anim_inb/datasets/SU_24fps/StevenHug_2048x1024_smol_sequential_halfhalf_csv \
# --log_path=train_log_bs16_e4000
...
# --batch_size=16 \
# --csv_root=/fs/cfar-projects/anim_inb/datasets/SU_24fps/StevenHug_2048x1024_smol_sequential_halfhalf_csv \
# --log_path=train_log_bs16_e4000_1
