...
def export(scn, t_opt, s_opt, r_opt, i):
    ...
    # outfilepath_jpg = "/Users/lilhuang/Desktop/Blender/"+outdirname+"_jpg/frame_"
    # # outfilepath_jpg = "/vulcanscratch/lilhuang/Blender/datasets/"+outdirname+"_jpg/frame_"
    # scn.render.filepath = outfilepath_jpg
    # bpy.ops.render.render(animation=True)

    # settings.file_format = "PNG"
    # outfilepath_png = "/Users/lilhuang/Desktop/Blender/"+outdirname+"_png/frame_"
    # # outfilepath_jpg = "/vulcanscratch/lilhuang/Blender/datasets/"+outdirname+"_png/frame_"
    # scn.render.filepath = outfilepath_png
    # bpy.ops.render.render(animation=True)

    # #export as ffmpeg
    settings.file_format = "FFMPEG"
    outfilepath_vid = "/Users/lilhuang/Desktop/Blender/TESTTTTTTT_"+outdirname+"/video_"
    # outfilepath_jpg = "/vulcanscratch/lilhuang/Blender/datasets/"+outdirname+"/video_"
...
def main3():
    ...
    points_on_curve, curve, ops_mesh, count = create_bezier()
...
def main2():
    ...
    # points_on_curve, bez_curve, res_per_section, bez_len, ops_mesh = create_mult_knot_bezier()
    points_on_curve, bez_curve, ops_mesh, count = create_bezier()
...
def main():
    ...
    # bezier_pts = create_bezier()
    bezier_pts = create_mult_knot_bezier()
    ...
    ######## some stuff from when i tried to get each face to be a diff color#######
    ...
    # they represent (u_x, u_y, u_z, theta), theta in radians
    ...
    for f in range(0, fcount, 1):
        ...
        # Translate.
        # currobj.location = smootherstep(pts, fprc, currpt)
        currobj.location = smootherstep(bezier_pts, fprc, currpt)
        currobj.keyframe_insert(data_path='location')
