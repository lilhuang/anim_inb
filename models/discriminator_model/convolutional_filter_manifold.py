...
class ConvolutionalFilterManifold(torch.nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, dilation=1, padding=0, transposed=False, bias=True, manifold_channels=64, activation=torch.nn.LeakyReLU, manifold_bias=True):
