...
csv_filename = '_JamesBaxterMoses_2s_3ib.csv'
...
dataset = "pt_JamesBaxterMoses" #either "suzanne_exr", "blender_cubes", "suzanne", or "SU"
test_size = (2048, 1024)
...
namename = "final_pt_JamesBaxterMoses_"
