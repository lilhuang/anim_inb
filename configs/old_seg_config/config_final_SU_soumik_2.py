...
metrics_dir = 'outputs/avi_SU_FINAL_METRICS_results_2'
train_store_path = 'outputs/avi_SU_FINAL_TRAIN_results_2'
test_store_path = 'outputs/avi_SU_FINAL_TEST_results_2'

loss_img_path = 'SU_FINAL_img_2.png'
checkpoint_latest_dir = '/fs/cfar-projects/anim_inb/checkpoints/latest_model_SU_FINAL_SOUMIK_2'
