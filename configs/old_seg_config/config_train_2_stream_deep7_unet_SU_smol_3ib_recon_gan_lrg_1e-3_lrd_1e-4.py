...
metrics_dir = 'outputs/avi_SU_smol_train_2_stream_'+str(num_ib_frames)+'ib_lrg_1e-3_lrd_1e-4_seqlr_deep7_unet_recon_gan_METRICS_results'
train_store_path = 'outputs/avi_SU_smol_train_2_stream_'+str(num_ib_frames)+'ib_lrg_1e-3_lrd_1e-4_seqlr_deep7_unet_recon_gan_TRAIN_results'
test_store_path = 'outputs/avi_SU_smol_train_2_stream_'+str(num_ib_frames)+'ib_lrg_1e-3_lrd_1e-4_seqlr_deep7_unet_recon_gan_TEST_results'

loss_img_path = 'progress_SU_smol_train_2_stream_'+str(num_ib_frames)+'ib_lrg_1e-3_lrd_1e-4_seqlr_deep7_unet_recon_gan_img.png'
checkpoint_latest_dir = '/fs/cfar-projects/anim_inb/checkpoints/latest_model_SU_smol_train_2_stream_'+str(num_ib_frames)+'ib_lrg_1e-3_lrd_1e-4_seqlr_deep7_unet_recon_gan'
checkpoint_latest_file = 'latest_model_SU_smol_train_2_stream_'+str(num_ib_frames)+'ib_lrg_1e-3_lrd_1e-4_seqlr_deep7_unet_recon_gan_EPOCH_'
