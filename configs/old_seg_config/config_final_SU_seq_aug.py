...
csv_root = '/fs/cfar-projects/anim_inb/datasets/SU_24fps/StevenHug_2048x1024_smol_sequential_halfhalf_2_csv_aug'
...
metrics_dir = 'outputs/avi_SU_FINAL_METRICS_seq_halfhalf_2_results_aug'
train_store_path = 'outputs/avi_SU_FINAL_TRAIN_seq_halfhalf_2_results_aug'
test_store_path = 'outputs/avi_SU_FINAL_FULL_seq_halfhalf_2_results_aug'

loss_img_path = 'SU_FINAL_seq_halfhalf_2_img_aug.png'
checkpoint_latest_dir = '/fs/cfar-projects/anim_inb/checkpoints/latest_model_SU_FINAL_seq_halfhalf_2_aug'
