...
metrics_dir = 'outputs/avi_SU_smol_'+str(num_ib_frames)+'ib_small_lrg_1e-3_deep7_unet_recon_warp_METRICS_results'
train_store_path = 'outputs/avi_SU_smol_'+str(num_ib_frames)+'ib_small_lrg_1e-3_deep7_unet_recon_warp_TRAIN_results'
test_store_path = 'outputs/avi_SU_smol_'+str(num_ib_frames)+'ib_small_lrg_1e-3_deep7_unet_recon_warp_TEST_results'

loss_img_path = 'progress_SU_smol_'+str(num_ib_frames)+'ib_small_lrg_1e-3_deep7_unet_recon_warp_img.png'
checkpoint_latest_dir = '/fs/cfar-projects/anim_inb/checkpoints/latest_model_SU_smol_'+str(num_ib_frames)+'ib_small_lrg_1e-3_deep7_unet_recon_warp'
checkpoint_latest_file = 'latest_model_SU_smol_'+str(num_ib_frames)+'ib_small_lrg_1e-3_deep7_unet_recon_warp_EPOCH_'
