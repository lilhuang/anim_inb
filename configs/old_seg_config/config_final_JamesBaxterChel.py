...
csv_root = '/fs/cfar-projects/anim_inb/datasets/vid_pngs_csvs'
csv_filename = '_JamesBaxterChel_2s_3ib.csv'
...
dataset = "pt_JamesBaxterChel" #either "suzanne_exr", "blender_cubes", "suzanne", or "SU"
test_size = (2048, 1024)
...
metrics_dir = 'outputs/final_pt_JamesBaxterChel_'+str(num_ib_frames)+'ib_METRICS_results'
train_store_path = 'outputs/final_pt_JamesBaxterChel_'+str(num_ib_frames)+'ib_TRAIN_results'
test_store_path = 'outputs/final_pt_JamesBaxterChel_'+str(num_ib_frames)+'ib_TEST_results'

loss_img_path = 'progress_final_pt_JamesBaxterChel_'+str(num_ib_frames)+'_img.png'
checkpoint_latest_dir = '/fs/cfar-projects/anim_inb/checkpoints/latest_model_final_pt_JamesBaxterChel_'+str(num_ib_frames)+'ib'
checkpoint_latest_file = 'latest_model_final_pt_JamesBaxterChel_'+str(num_ib_frames)+'ib_EPOCH_'
