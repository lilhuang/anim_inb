...
metrics_dir = 'outputs/avi_SU_smol_'+str(num_ib_frames)+'ib_lrg_1e-3_deep_unet_recon_METRICS_results'
train_store_path = 'outputs/avi_SU_smol_'+str(num_ib_frames)+'ib_lrg_1e-3_deep_unet_recon_TRAIN_results'
test_store_path = 'outputs/avi_SU_smol_'+str(num_ib_frames)+'ib_lrg_1e-3_deep_unet_recon_TEST_results'

loss_img_path = 'progress_SU_smol_'+str(num_ib_frames)+'ib_lrg_1e-3_deep_unet_recon_img.png'
checkpoint_latest_dir = '/fs/cfar-projects/anim_inb/checkpoints/latest_model_SU_smol_'+str(num_ib_frames)+'ib_lrg_1e-3_deep_unet_recon'
checkpoint_latest_file = 'latest_model_SU_smol_'+str(num_ib_frames)+'ib_lrg_1e-3_deep_unet_recon_EPOCH_'
