...
csv_filename = '_MiltKahlRobinHood_2s_3ib.csv'
...
dataset = "pt_MiltKahlRobinHood" #either "suzanne_exr", "blender_cubes", "suzanne", or "SU"
test_size = (2048, 1024)
...
namename = "final_pt_MiltKahlRobinHood_"
