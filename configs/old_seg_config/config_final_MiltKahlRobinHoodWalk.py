...
csv_filename = '_MiltKahlRobinHoodWalk_2s_1s_1ib.csv'
...
dataset = "pt_MiltKahlRobinHoodWalk" #either "suzanne_exr", "blender_cubes", "suzanne", or "SU"
test_size = (2048, 1024)
...
namename = "final_pt_MiltKahlRobinHoodWalk_"

metrics_dir = 'outputs/'+namename+str(num_ib_frames)+'ib_METRICS_results'
train_store_path = 'outputs/'+namename+str(num_ib_frames)+'ib_TRAIN_results'
test_store_path = 'outputs/'+namename+str(num_ib_frames)+'ib_TEST_results'

loss_img_path = 'progress'+namename+str(num_ib_frames)+'_img.png'
checkpoint_latest_dir = '/fs/cfar-projects/anim_inb/checkpoints/latest_model'+namename+str(num_ib_frames)+'ib'
checkpoint_latest_file = 'latest_model'+namename+str(num_ib_frames)+'ib_EPOCH_'
