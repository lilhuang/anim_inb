...
metrics_dir = 'outputs/final_pt_JamesBaxterChel_'+str(num_ib_frames)+'ib_seq_METRICS_results'
train_store_path = 'outputs/final_pt_JamesBaxterChel_'+str(num_ib_frames)+'ib_seq_TRAIN_results'
test_store_path = 'outputs/final_pt_JamesBaxterChel_'+str(num_ib_frames)+'ib_seq_TEST_results'

loss_img_path = 'progress_final_pt_JamesBaxterChel_'+str(num_ib_frames)+'_seq_img.png'
checkpoint_latest_dir = '/fs/cfar-projects/anim_inb/checkpoints/latest_model_final_pt_JamesBaxterChel_'+str(num_ib_frames)+'ib_seq'
checkpoint_latest_file = 'latest_model_final_pt_JamesBaxterChel_'+str(num_ib_frames)+'ib_seq_EPOCH_'
