...
num_workers = 0
batch_size = 1 #for 1 gpu, 1 patch discriminators
...
metrics_dir = 'outputs/ours_final_suzannes_METRICS_results'
train_store_path = 'outputs/ours_final_suzannes_TRAIN_results'
test_store_path = 'outputs/ours_final_suzannes_exr_1ib_TEST_results'
...
checkpoint_in = checkpoint_latest_dir+"/"+checkpoint_latest_file+str(cur_epoch)+".pth"
