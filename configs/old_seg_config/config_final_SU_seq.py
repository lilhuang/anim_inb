...
stream_share = True
stream_encoder_name = "resnet34_7" #resnet34_5, resnet34_6, or resnet34_7
stream_encoder_weights = None #imagenet or None
# stream_encoder_depth = 5 #5, 6, or 7
# stream_encoder_depth = 7
stream_encoder_depth = 3
# stream_decoder_channels = (1024, 512, 256, 128, 64, 32, 16) #add to/take away from the front
stream_decoder_channels = (64, 32, 16)
...
name = "shallow3_allnets_lr_1e-3"

metrics_dir = 'outputs/avi_SU_'+name+'_METRICS_results_'
train_store_path = 'outputs/avi_SU_'+name+'_TRAIN_results_'
test_store_path = 'outputs/avi_SU_'+name+'_TEST_results_'
