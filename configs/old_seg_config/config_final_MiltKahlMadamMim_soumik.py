...
csv_filename = '_MiltKahlMadamMim_1s_2s_1ib.csv'
...
dataset = "pt_MiltKahlMadamMim" #either "suzanne_exr", "blender_cubes", "suzanne", or "SU"
test_size = (2048, 1024)
...
namename = "final_pt_MiltKahlMadamMim_"
