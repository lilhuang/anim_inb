...
metrics_dir = 'outputs/avi_suzannes_exr_'+str(num_ib_frames)+'ib_recon_gan_lrg_1e-3_deep_unet_METRICS_results'
train_store_path = 'outputs/avi_suzannes_exr_'+str(num_ib_frames)+'ib_recon_gan_lrg_1e-3_deep_unet_TRAIN_results'
test_store_path = 'outputs/avi_suzannes_exr_'+str(num_ib_frames)+'ib_recon_gan_lrg_1e-3_deep_unet_TEST_results'

loss_img_path = 'progress_suzannes_exr_'+str(num_ib_frames)+'ib_recon_gan_lrg_1e-3_deep_unet_img.png'
checkpoint_latest_dir = '/fs/cfar-projects/anim_inb/checkpoints/latest_model_suzannes_exr_'+str(num_ib_frames)+'ib_recon_gan_lrg_1e-3_deep_unet_'
checkpoint_latest_file = 'latest_model_suzannes_exr_'+str(num_ib_frames)+'ib_recon_gan_lrg_1e-3_deep_unet_EPOCH_'
