...
csv_root = '/fs/cfar-projects/anim_inb/datasets/SU_24fps/StevenHug_2048x1024_smol_sequential_halfhalf_2_csv_aug_2'
# csv_root = '/fs/cfar-projects/anim_inb/datasets/SU_24fps/StevenHug_2048x1024_smol_sequential_halfhalf_testonly_2_csv'
trainflow_root = "bleh" #"/fs/cfar-projects/anim_inb/pips/generate_flows/flows_su_smol_2048x1024"
testflow_root = "bleh" #"/fs/cfar-projects/anim_inb/pips/generate_flows/flows_su_smol_2048x1024"
...
metrics_dir = 'outputs/avi_SU_FINAL_METRICS_seq_halfhalf_2_results_aug_2'
train_store_path = 'outputs/avi_SU_FINAL_TRAIN_seq_halfhalf_2_results_aug_2'
test_store_path = 'outputs/avi_SU_FINAL_FULL_seq_halfhalf_2_results_aug_2'

loss_img_path = 'SU_FINAL_seq_halfhalf_2_img_aug_2.png'
checkpoint_latest_dir = '/fs/cfar-projects/anim_inb/checkpoints/latest_model_SU_FINAL_seq_halfhalf_2_aug_2'
