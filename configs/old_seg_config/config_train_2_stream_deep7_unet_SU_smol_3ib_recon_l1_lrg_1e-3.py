...
metrics_dir = 'outputs/avi_SU_smol_train_2_stream_'+str(num_ib_frames)+'ib_lrg_1e-3_deep7_unet_recon_l1_METRICS_results'
train_store_path = 'outputs/avi_SU_smol_train_2_stream_'+str(num_ib_frames)+'ib_lrg_1e-3_deep7_unet_recon_l1_TRAIN_results'
test_store_path = 'outputs/avi_SU_smol_train_2_stream_'+str(num_ib_frames)+'ib_lrg_1e-3_deep7_unet_recon_l1_TEST_results'

loss_img_path = 'progress_SU_smol_warp_then_train_2_stream_'+str(num_ib_frames)+'ib_lrg_1e-3_deep7_unet_recon_l1_img.png'
checkpoint_latest_dir = '/fs/cfar-projects/anim_inb/checkpoints/latest_model_SU_smol_warp_then_train_2_stream_'+str(num_ib_frames)+'ib_lrg_1e-3_deep7_unet_recon_l1'
checkpoint_latest_file = 'latest_model_SU_smol_warp_then_train_2_stream_'+str(num_ib_frames)+'ib_lrg_1e-3_deep7_unet_recon_l1_EPOCH_'
