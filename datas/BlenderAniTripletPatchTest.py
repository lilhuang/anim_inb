...
class BlenderAniTripletPatchTest(data.Dataset):
    def __init__(self, data_root, csv_root, num_ib_frames, data_source, \
        ...
        framesPath, \
            framesFolder, \
            framesIndex, \
            flowPath = _make_csv_dataset(data_root, csv_root, num_ib_frames, \
