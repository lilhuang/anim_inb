...
def _make_dataset(data_root, num_inbs, overfit=False):
    ...
    for folder in all_folders:
        ...
        for i, example in enumerate(all_examples):
            ...
            inb2frame = os.path.join(data_root_3, example, "frame_3.png")
            trg2frame = os.path.join(data_root_3, example, "frame_4.png")

            out_foldername = folder+"_"+ex_num+"_"+patchname_0+"_"+patchname_1
...
class CSVEXRQuintlet(data.Dataset):
